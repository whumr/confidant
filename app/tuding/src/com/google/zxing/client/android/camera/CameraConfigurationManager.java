...
public final class CameraConfigurationManager {
	...
	public void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		CameraConfigurationUtils.setFocus(parameters, CameraConfig.AUTO_FOCUS,
				CameraConfig.DISABLE_CONTINUOUS_FOCUS, safeMode);

		if (!safeMode) {
			if (CameraConfig.INVERT_SCAN) {
				CameraConfigurationUtils.setInvertColor(parameters);
			}

			if (!CameraConfig.DISABLE_BARCODE_SCENE_MODE) {
				CameraConfigurationUtils.setBarcodeSceneMode(parameters);
			}

			if (!CameraConfig.DISABLE_METERING) {
	...
	private void doSetTorch(Camera.Parameters parameters, boolean newSetting,
		...
		if (!safeMode && !CameraConfig.DISABLE_EXPOSURE) {
